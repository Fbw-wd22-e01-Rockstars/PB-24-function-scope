...
function exponentialNumber(num1,num2){
    let result = ""
...
exponentialNumber(3,5)
exponentialNumber(2,8)
...
function printFavoriteFruit(){
    fruit = "Melon"
    console.log(`My favorite fruit is: _${fruit}_`)
}
...
// result is functional scoped varaible ,we can't access from outside of that function
